...
export default function OrderOnWhatsAppButton({ href, code, name, inStock }: Props) {
  return (
    <a
      href={href}
      target="_blank"
      ...
      onClick={() => trackWhatsAppOrderClick({ code, name })}
    ...
    >
      <WhatsAppIcon />
      {inStock ? "Order on WhatsApp" : "Enquire on WhatsApp"}
    </a>
  );
}
